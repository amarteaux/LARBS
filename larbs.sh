...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/amarteaux/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/amarteaux/LARBS/master/progs.csv"
